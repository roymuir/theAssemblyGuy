...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_theme_page(__('Revera Options', 'options_framework_theme'), __('Revera Options', 'options_framework_theme'), 'edit_theme_options', 'options-framework','optionsframework_page');
...
function themetor_set_demo_data($dv){
	...
	set_theme_mod( 'nav_menu_locations' , array('primary' => $main_menu->term_id, 'onepage' => $onepage_menu->term_id ) );
	
	
	//Import Widgets
	update_option('sidebars_widgets', '');
	
	tt_addWidget( 'footer_widgets' , 'text', 0, array('title' => 'The Details','text' => '<a href="mailto:hello@revera.com">hello@revera.com</a><br><a href="tel:+22155590210">+221 555 90210</a>'));
	tt_addWidget( 'footer_widgets' , 'text', 0, array('title' => 'Our Office','text' => '<a href="#">247 Sofake Blvd. New York<br>NY 10027, USA</a>'));
	tt_addWidget( 'footer_widgets' , 'text', 0, array('title' => 'Opening Hours','text' => 'Monday - Friday<br>9.30 am - 5.30 pm'));
	
	tt_addWidget( 'sidebar-blog', 'search', 0);
	tt_addWidget( 'sidebar-blog' , 'text', 0, array('title' => '','text' =>'<div class="bannerwidget"><a href="#"><img src="http://demo.themetor.com/revera/wp-content/uploads/2015/01/blog-banner.jpg" alt="blog-banner"></a></div>'));
	tt_addWidget( 'sidebar-blog' , 'text', 0, array('title' => 'Text Widget','text' =>'This is the text widget so you can tell the world anything you like. You can also add an image inside this or any other HTML elements. Lorem ipsum dolor sit amet, you know it.'));
	tt_addWidget( 'sidebar-blog', 'categories', 0);
	tt_addWidget( 'sidebar-blog', 'tag_cloud', 0, array('title' => 'Tags'));
	tt_addWidget( 'sidebar-blog', 'archives', 0, array('title' => 'Archives'));
	tt_addWidget( 'sidebar-blog', 'recent-posts', 0);
	tt_addWidget( 'sidebar-blog', 'calendar', 0);
	
	tt_addWidget( 'sidebar-search', 'search', 0);
	tt_addWidget( 'sidebar-search' , 'text', 0, array('title' => 'Text Widget','text' =>'This is the text widget so you can tell the world anything you like. You can also add an image inside this or any other HTML elements. Lorem ipsum dolor sit amet, you know it.'));
	tt_addWidget( 'sidebar-search', 'categories', 0);
...
function optionsframework_adminbar() {
	...
	global $wp_admin_bar;
		...
		$wp_admin_bar->add_menu( array(
				'id' => 'of_theme_options',
				'title' => __( 'Revera Options', 'options_framework_theme' ),
